...
import { CheckSquare, ChevronDown, ChevronUp, Cpu } from 'react-feather';
import HkTooltip from '@/components/@hk-tooltip/HkTooltip';
import { useGlobalStateContext } from '@/context/GolobalStateProvider';

/**
 * Header da página de assistentes
 */
const AssistantsHeader = ({ toggleSidebar, show }) => {
    ...
    <header className="integrations-header">
      <div className="d-flex flex-1">
        ...
        <Form.Select className="d-md-none mw-300p ms-3">
          <option value={1}>Todos os Assistentes</option>
          <option value={2}>Assistentes Ativos</option>
        </Form.Select>
      </div>
        ...
        <Nav as="ul" className="nav-line nav-tabs nav-icon nav-light flex-shrink-0 px-2">
          <Nav.Item as="li">
            <Nav.Link className="d-flex align-items-center h-100 active">
              ...
              <span className="nav-link-text">Todos os Assistentes</span>
            </Nav.Link>
          </Nav.Item>
          <Nav.Item as="li">
            <Nav.Link className="d-flex align-items-center h-100">
              ...
              <span className="nav-link-text">Assistentes Ativos</span>
            </Nav.Link>
          </Nav.Item>
        </Nav>
      </div>
