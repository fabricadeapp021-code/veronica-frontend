...
const PROMPT_SECTIONS = [
  ...
  },
  {
    ...
    file: 'BOOTSTRAP.md',
    icon: Zap,
    helper: 'Instrucoes de inicializacao executadas pelo agente ao ser carregado pelo OpenClaw.',
    questions: [
      'O que o agente deve fazer ao iniciar?',
      'Ha checagens ou rotinas de boot necessarias?',
      'Quais contextos iniciais devem ser carregados?',
    ],
  },
  {
    key: 'MEMORY',
