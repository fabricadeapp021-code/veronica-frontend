...
const VideoGeneratorHeader = ({ toggleSidebar }) => {
    return (
        <header className="contact-header">
            <div className="d-flex align-items-center">
                ...
                <div className="ms-3 d-flex align-items-center gap-3">
                    ...
                    <div>
                        <h5 className="mb-0">Gerador de Vídeos com Avatar</h5>
                        <div className="small text-muted">Crie vídeos profissionais com avatar IA</div>
                    </div>
                </div>
            </div>
            <div className="contact-options-wrap">
                ...
                <Dropdown>
                    ...
                    <Dropdown.Menu align="end">
                        <Dropdown.Item>
                            <Icons.Video size={16} className="me-2" />
                            Meus Vídeos
                        </Dropdown.Item>
                        <Dropdown.Item>
