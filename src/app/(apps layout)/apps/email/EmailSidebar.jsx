                ...
                <SimpleBar className="nicescroll-bar">
                    <div className="menu-content-wrap">
                        ...
                        <div className="d-flex align-items-center justify-content-between mb-2">
                            <div className="title-sm text-primary mb-0">Categorias</div>
                            <Button size="xs" variant="light" className="btn-icon btn-rounded" onClick={() => setAddCategory(!addCategory)} >
                                <HkTooltip id="tooltip1" placement="top" title="Adicionar Categoria" >
                                    <span className="feather-icon">
                                        <Plus />
                                    </span>
                                </HkTooltip>
            ...
            <Modal show={addCategory} onHide={() => setAddCategory(!addCategory)} centered size="sm" >
                <div className="modal-content">
                    <Modal.Body>
                        ...
                        <h6 className="text-uppercase fw-bold mb-3">Adicionar Categoria</h6>
                        <Form>
                            <Row className="gx-3">
                                <Col sm={12}>
                            ...
                            <Button variant="primary" className="float-end" onClick={() => setAddCategory(!addCategory)} >Adicionar</Button>
                        </Form>
                    </Modal.Body>
                </div>
            </Modal>
