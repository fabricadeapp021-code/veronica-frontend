        ...
        <div className="email-body">
            <SimpleBar className="nicescroll-bar">
                <div className="single-email-subject">
                    <div>
                        <h4 className="fw-light">Cronograma das carreatas - Zona Norte</h4>
                        <Badge bg="orange" pill className="badge-sm flex-shrink-0 ms-3">campanha</Badge>
                    </div>
                                    ...
                                    <div className="email-head-action">
                                        ...
                                        <Dropdown>
                                            ...
                                            <Dropdown.Menu align="end">
                                                <Dropdown.Item>Encaminhar</Dropdown.Item>
                                                <Dropdown.Item>Deletar</Dropdown.Item>
                                                <Dropdown.Item>Reportar Spam</Dropdown.Item>
                                            </Dropdown.Menu>
                                        </Dropdown>
                                    </div>
                                </div>
                                            ...
                                            <Card.Body>
                                                <Form.Group>
                                                    <div className="d-flex flex-wrap">
                                                        ...
                                                        <Form.Control type="text" className="border-0 p-0 shadow-none flex-1 mb-2 me-2" placeholder="Adicionar destinatários" />
                                                    </div>
                                                </Form.Group>
                                                <Form.Group>
                                                    <Form.Control as="textarea" rows={8} placeholder="Digite sua mensagem" className="mb-3" />
                                                </Form.Group>
                                                <Form.Group className="d-flex justify-content-between mb-0">
                                                    <div>
                                                        <Button variant="primary" className="me-2" type="submit">Enviar</Button>
                                                        <Button variant="flush-dark" className="btn-icon btn-rounded flush-soft-hover">
                ...
                <div id="accordionSimpleExample" className="accordion accordion-simple single-email-thread">
                    ...
                    <div className="accordion-item">
                        ...
                        <div id="simple-collapseTwo" className="collapse show">
                            <div className="accordion-body">
                                <p>Olá Candidato, envio o cronograma completo das carreatas na Zona Norte para os próximos 15 dias. Precisamos confirmar sua presença nos eventos principais e definir o roteiro das visitas aos bairros.</p>
                                <p className="mb-4">Por favor, revise os documentos anexos e confirme sua disponibilidade até amanhã às 18h.</p>
                                <p>Atenciosamente,<br />Carlos Mendes<br />Coordenador - Zona Norte</p>
                                <Image className="d-block mt-2 mb-3" src={sign} alt="signature" />
                            </div>
                        </div>
                    </div>
                    <div className="accordion-item">
                        ...
                        <div id="simple-collapseThree" className="collapse show">
                            <div className="accordion-body">
                                <p>Olá Carlos,</p>
                                <p>Obrigado pelo cronograma. Poderia especificar quais são os horários disponíveis para o comício do dia 28? Gostaria de confirmar a logística.</p>
                                <div className="my-5">
                                    <Button variant="outline-light" className="me-2" data-bs-toggle="collapse" data-bs-target="#compose_email" aria-expanded="false">
                                        <span>
                                            <span className="icon">
