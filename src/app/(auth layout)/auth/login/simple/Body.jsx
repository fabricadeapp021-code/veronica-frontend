                        ...
                        <div className="auth-content py-md-0 py-8">
                            <Row>
                                <Col xxl={9} xl={8} lg={11} className="text-center mx-auto">
                                    ...
                                    <h3 className="mb-2">OpenClaw SaaS</h3>
                                    <p className="w-xxl-65 w-100 mx-auto">Controle agentes, tenants e automações com observabilidade operacional.</p>
                                    <Button size="sm" variant="primary" className="btn-uppercase mt-4">Ver painel</Button>
                            ...
                            <Form className="w-100" onSubmit={e => handleSubmit(e)} >
                                <Row>
                                    <Col lg={10} className="mx-auto">
                                        <h4 className="mb-4">Entrar no OpenClaw SaaS</h4>
                                        <Row className="gx-3">
                                        ...
                                        <p className="p-xs mt-2 text-center">Novo no OpenClaw? <a href="/auth/signup"><u>Criar conta</u></a></p>
                                    </Col>
                                </Row>
                            </Form>
                        </div>
