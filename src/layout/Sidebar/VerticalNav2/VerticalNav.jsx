...
import { Accordion, AccordionContext, Card, ListGroup, Nav, useAccordionButton } from 'react-bootstrap';
...
const VerticalNav = () => {
    ...
    // 🆕 Hook de permissões para filtrar menu
    ...
    const filteredMenu = DashboardMenu.filter(menu => {
        ...
        return hasPermission(menu.permission.module, menu.permission.action);
    });
